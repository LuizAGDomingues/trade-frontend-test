...
function SobreDialog() {
  return (
    <Dialog.Root>
      ...
      <Dialog.Portal>
        <Dialog.Overlay />
        <Dialog.Content className='w-[700px] h-[472] bg-[#D5E2F1] rounded-3xl border py-6 px-12 border-black flex flex-col items-center font-bold text-lg absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2'>
