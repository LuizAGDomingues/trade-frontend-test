    ...
    <Dialog.Root>
      ...
      <Dialog.Portal>
        ...
        <Dialog.Content className='w-[664px] bg-[#D5E2F1] rounded-3xl border py-6 px-12 border-black flex flex-col items-center font-bold text-lg absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2'>
          ...
          <form action="submit" className='mt-7 mb-12 w-full flex flex-col items-center'>
            ...
            <button type="submit" className='mt-8 bg-[#EFD117] hover:bg-[#c7b332] transition-all rounded-full w-28 px-7 py-2 text-black font-bold text-lg'>Entrar</button>
          </form>
        </Dialog.Content>
      </Dialog.Portal>
    </Dialog.Root>
