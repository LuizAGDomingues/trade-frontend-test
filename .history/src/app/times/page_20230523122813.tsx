...
export default function Times() {
  ...
  useEffect(() => {
    const { data: leagueData, isLoading: leagueLoading, error: leagueError } = useQuery('league', () => {
    ...
    <div className="w-full h-screen bg-[#223142] text-white px-7">
      ...
      <div className='flex justify-between'>
        <form action="" className='flex flex-col mt-28'>
          ...
          <select name="pais" id="pais" onChange={e => setPais(e.target.value)} disabled={pais} className='bg-[#D5E2F1] px-3 py-2 rounded-lg w-[308px] mt-1 text-black'>
            <option value=""></option>
