    ...
    <div className="w-full h-screen bg-[#223142] text-white px-7">
      ...
      <div className='flex justify-between'>
        <form action="" className='flex flex-col mt-28'>
          ...
          <input type="text" className='bg-[#D5E2F1] px-3 py-1 rounded-lg w-[308px] mt-1' placeholder='Brazil'/>
          <label htmlFor="" className='mt-6'>Selecione a liga</label>
          <input type="text" className='bg-[#D5E2F1] px-3 py-1 rounded-lg w-[308px] mt-1'placeholder='Brasileirão Série A'/>
          <label htmlFor="" className='mt-6'>Selecione a temporada</label>
          <input type="text" className='bg-[#D5E2F1] px-3 py-1 rounded-lg w-[308px] mt-1'placeholder='2023'/>
        </form>
