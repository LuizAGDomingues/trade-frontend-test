...
const db = [{name: 'brasil', code: 'br'},{name: 'brasil', code: 'qw'},{name: 'brasil', code: 'we'},{name: 'brasil', code: 'er'},{name: 'brasil', code: 'rt'},{name: 'brasil', code: 'ty'},{name: 'brasil', code: 'yu'},{name: 'brasil', code: 'ui'},{name: 'brasil', code: 'io'},{name: 'brasil', code: 'op'},{name: 'brasil', code: 'as'},{name: 'brasil', code: 'sd'},{name: 'brasil', code: 'df'},{name: 'brasil', code: 'fg'},{name: 'brasil', code: 'gh'},{name: 'brasil', code: 'hj'},{name: 'brasil', code: 'jk'},{name: 'brasil', code: 'kl'},{name: 'brasil', code: 'zx'},{name: 'brasil', code: 'xc'},{name: 'brasil', code: 'cv'},{name: 'brasil', code: 'vb'},{name: 'brasil', code: 'bn'},{name: 'brasil', code: 'nm'}]
      ...
      <div className='flex justify-between'>
        <form action="" className='flex flex-col mt-28'>
          ...
          <select name="pais" id="pais" className='bg-[#D5E2F1] px-3 py-2 rounded-lg w-[308px] mt-1 text-black'>
            <option value=""></option>
            {data.response.map((pais: { code: string; name: string }) => {
              <option value={pais.code} key={pais.code}>{pais.name}</option>
            })}
          </select>
