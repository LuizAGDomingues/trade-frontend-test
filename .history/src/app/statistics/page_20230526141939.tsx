        ...
        <div className='flex flex-col items-start w-[308px]'>
          ...
          <table>
            <thead>
              <tr>
                <th></th>
                <th className="text-center pl-9">Casa</th>
                <th className="text-center pl-14">Fora</th>
                <th className="text-center pl-14">Total</th>
              </tr>
            </thead>
            <tbody>
              <tr>
                <td>Jogos</td>
                <td className="pl-12">11</td>
                <td className="pl-7">10</td>
                <td className="pl-7">21</td>
              </tr>
              <tr>
                <td>Vitórias</td>
                <td className="pl-12">11</td>
                <td className="pl-12">10</td>
                <td className="pl-12">21</td>
              </tr>
              <tr>
                <td>Empates</td>
                <td className="pl-12">11</td>
