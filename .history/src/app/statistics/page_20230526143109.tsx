...
function page() {
  ...
  if(timeStatisticsLoading || timeSquadLoading) {
    return <section className='statisticpage w-full h-screen flex items-center justify-center px-7 pb-20 text-white'></section>
  }
        ...
        <div className='flex flex-col items-start w-[308px]'>
          ...
          <table>
            ...
            <tbody>
              <tr>
                <td>Jogos</td>
                <td className="pl-8">11</td>
                <td className="pl-3">10</td>
                <td className="pl-3">21</td>
              </tr>
              <tr>
                <td>Vitórias</td>
                <td className="pl-8">11</td>
