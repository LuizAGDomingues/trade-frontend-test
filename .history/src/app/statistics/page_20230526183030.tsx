...
function page() {
  ...
  const [ timeStatisticsData, setTimeStatisticsData ] = useState<anydd>()
  ...
  useEffect(() => {
    ...
    }).then((response) => setTimeStatisticsData(response.data.response))
  }, [])
  ...
  if(timeStatisticsData === undefined || players === undefined) {
