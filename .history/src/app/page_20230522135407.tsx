    ...
    <>
      <main className="w-full h-screen">
        ...
        <div className="flex">
          ...
          <div>
            <p className="text-xl text-center w-[356px] mt-[350px]">Cadastre-se agora e faça parte da comunidade Meu Time. Explore o mundo do futebol de uma maneira nova e emocionante, acompanhando seu clube do coração em cada jogada, gol e vitória. Não perca tempo, junte-se a nós e mostre todo o seu amor pelo futebol!"</p>
          </div>
        </div>
      </main>
